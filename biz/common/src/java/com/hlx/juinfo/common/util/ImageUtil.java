...
public class ImageUtil {
     ...
     * @param imgUrl
     */
    public static void toLocalImageByUrl(String imgUrl, String outfilepath) {
        ...
        try {
            ...
            File imageFile = new File(outfilepath+path+System.currentTimeMillis()+prefix);
            // 创建输出流
    ...
    public  static void main(String[] aa){
        ...
        ImageUtil imgservice=new ImageUtil();
        imgservice.toLocalImageByUrl(imgUrl, "c:/");
    }
