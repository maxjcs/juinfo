...
3. 在工程根目录中svn:externals引入bundle/rpm/framework目录（注意命令最后有一个点）：
   [~/exodus2]$ svn propset svn:externals "bundle/rpm/framework http://svn.alibaba-inc.com/repos/ali_cn/misc/scm-scripts/rpm/framework" .
